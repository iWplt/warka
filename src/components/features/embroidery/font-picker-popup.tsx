...
export function FontPickerPopup({
  ...
  }, [open, previewText, selectedFontFamily, fonts]);
  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        <Dialog.Overlay className="fixed inset-0 z-[70] bg-warka-text/25 backdrop-blur-[2px] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0" />
        <Dialog.Content
          className={cn(
            "fixed z-[71] flex flex-col overflow-hidden border border-warka-border bg-card text-warka-text shadow-tint-lg outline-none",
