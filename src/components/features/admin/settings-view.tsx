...
export function SettingsView({
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-warka-primary/20 bg-warka-primary/5 p-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">{t("sizesLinkHint")}</p>
          </div>
      ...
      <div className="rounded-2xl glass p-6">
        <h2 className="mb-4 font-semibold">{t("priceCatalog")}</h2>
